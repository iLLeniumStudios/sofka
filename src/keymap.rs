...
actions! {
    ...
    AddSource => ("add_source", "add a kubeconfig file or directory"),
...
const DEFAULTS: &[(&str, Action, &[&str])] = &[
    ...
    ("help", Action::Up, &["k", "up"]),
    ("kubeconfigs", Action::Accept, &["enter"]),
    ("kubeconfigs", Action::AddSource, &["a"]),
    ("kubeconfigs", Action::Back, &["esc"]),
    ("kubeconfigs", Action::Delete, &["d"]),
    ("kubeconfigs", Action::Down, &["j", "down"]),
    ("kubeconfigs", Action::Up, &["k", "up"]),
